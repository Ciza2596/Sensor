...
{
    public class CircleSensorTest : BaseSensorTest
    {
        private CircleSensor _sensor;

        [SetUp]
        public void SetUp() {
            var boxSensorObject = new GameObject();
            _sensor = boxSensorObject.AddComponent<CircleSensor>();
        ...
        public void When_SameLayerAndSamePosition_Then_SensorTrigger(int  sensorLayer,
            ...
            var setting = new CircleSensor.Setting(layerMask);
