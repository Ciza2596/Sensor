...
{
    public class CapsuleSensorTest : BaseSensorTest
    {
        private CapsuleSensor _sensor;

        [SetUp]
        public void SetUp() {
            var boxSensorObject = new GameObject();
            _sensor = boxSensorObject.AddComponent<CapsuleSensor>();
        ...
        public void When_SameLayerAndSamePosition_Then_SensorTrigger(int  sensorLayer,
            ...
            var setting = new CapsuleSensor.Setting(layerMask);
